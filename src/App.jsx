    ...
    <div className="min-h-screen flex flex-col relative overflow-hidden safe-top safe-bottom">
      ...
      <div className="relative z-10 flex flex-col items-center gap-5 sm:gap-8 px-4">
        ...
        <a
          ...
          className="flex items-center gap-2 text-xs text-white/70 tracking-widest uppercase border border-white/20 hover:border-white/50 hover:text-white px-3 py-1.5 rounded transition-all duration-200 hover:bg-white/5"
        >
...
const ISO_TO_GAME = {
  ...
  '012': { type: 'neutral', id: 'algeria' },
  '788': { type: 'neutral', id: 'tunisia' },
  '024': { type: 'neutral', id: 'angola' },
  '050': { type: 'neutral', id: 'bangladesh' },
  '144': { type: 'neutral', id: 'sri_lanka' },
  '116': { type: 'neutral', id: 'cambodia' },
  '418': { type: 'neutral', id: 'laos' },
  '400': { type: 'neutral', id: 'jordan' },
  '422': { type: 'neutral', id: 'lebanon' },
  '784': { type: 'neutral', id: 'uae' },
  '512': { type: 'neutral', id: 'oman' },
  '112': { type: 'neutral', id: 'belarus' },
  '688': { type: 'neutral', id: 'serbia' },
  '348': { type: 'neutral', id: 'hungary' },
  '040': { type: 'neutral', id: 'austria' },
  '528': { type: 'neutral', id: 'netherlands' },
  '056': { type: 'neutral', id: 'belgium' },
  '834': { type: 'neutral', id: 'tanzania' },
  '800': { type: 'neutral', id: 'uganda' },
  '466': { type: 'neutral', id: 'mali' },
  '562': { type: 'neutral', id: 'niger' },
  '148': { type: 'neutral', id: 'chad' },
  '516': { type: 'neutral', id: 'namibia' },
  '508': { type: 'neutral', id: 'mozambique' },
  '894': { type: 'neutral', id: 'zambia' },
  '598': { type: 'neutral', id: 'papua_new_guinea' },
  '218': { type: 'neutral', id: 'ecuador' },
  '858': { type: 'neutral', id: 'uruguay' },
  '558': { type: 'neutral', id: 'nicaragua' },
  '188': { type: 'neutral', id: 'costa_rica' },
  '352': { type: 'neutral', id: 'iceland' },
  '031': { type: 'neutral', id: 'azerbaijan' },
  '051': { type: 'neutral', id: 'armenia' },
  '268': { type: 'neutral', id: 'georgia_c' },
  '860': { type: 'neutral', id: 'uzbekistan' },
  '762': { type: 'neutral', id: 'tajikistan' },
  '454': { type: 'neutral', id: 'malawi' },
  '646': { type: 'neutral', id: 'rwanda' },
}
