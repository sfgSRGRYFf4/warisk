...
export const NEUTRAL_LABELS = {
  ...
  // --- BATCH 4 — new countries without jokes ---
  algeria:         { name: "Algeria",       label: "France's longest breakup. 132 years to leave.",           x: 280, y: 245 },
  tunisia:         { name: "Tunisia",       label: "Where the Arab Spring started. We watched.",               x: 300, y: 230 },
  angola:          { name: "Angola",        label: "Civil war for 27 years. CIA picked both sides. Classic.",  x: 355, y: 375 },
  bangladesh:      { name: "Bangladesh",    label: "170M people. Somehow not on our map.",                     x: 588, y: 265 },
  sri_lanka:       { name: "Sri Lanka",     label: "Ran out of money. Sold the presidential palace. Mood.",    x: 568, y: 300 },
  cambodia:        { name: "Cambodia",      label: "We bombed it secretly for 4 years. Shhh.",                 x: 640, y: 285 },
  laos:            { name: "Laos",          label: "Most bombed country per capita. We lost count.",           x: 630, y: 268 },
  jordan:          { name: "Jordan",        label: "Neutral in every war. Professionally.",                    x: 382, y: 265 },
  lebanon:         { name: "Lebanon",       label: "Used to be the Paris of the Middle East. Used to.",        x: 372, y: 248 },
  uae:             { name: "UAE",           label: "Built on sand and migrant labor. Not our problem.",         x: 448, y: 290 },
  oman:            { name: "Oman",          label: "Has oil. Suspiciously quiet. We're watching.",              x: 462, y: 305 },
  belarus:         { name: "Belarus",       label: "Europe's last dictator. We made a strongly worded tweet.", x: 360, y: 130 },
  serbia:          { name: "Serbia",        label: "We bombed them in '99. Now they sell us raspberries.",     x: 330, y: 165 },
  hungary:         { name: "Hungary",       label: "In the EU but vibes like it left.",                        x: 322, y: 155 },
  austria:         { name: "Austria",       label: "Started WW1. Now just makes Mozart balls.",                x: 304, y: 153 },
  netherlands:     { name: "Netherlands",   label: "Legal weed, legal everything. We study their methods.",    x: 274, y: 132 },
  belgium:         { name: "Belgium",       label: "NATO HQ is here. Also: 400 types of beer.",                x: 272, y: 140 },
  tanzania:        { name: "Tanzania",      label: "Kilimanjaro and Zanzibar. Rich in assets, not cash.",      x: 428, y: 360 },
  uganda:          { name: "Uganda",        label: "Kony 2012. We cared for about 3 weeks.",                   x: 405, y: 335 },
  mali:            { name: "Mali",          label: "We had troops here. Then we didn't. Then we did.",         x: 270, y: 288 },
  niger:           { name: "Niger",         label: "Coup in 2023. We 'condemned' it and moved on.",            x: 305, y: 283 },
  chad:            { name: "Chad",          label: "The country is named Chad. Still lost every war.",         x: 348, y: 278 },
  namibia:         { name: "Namibia",       label: "Germany's forgotten colony. Germany forgot. We noticed.",  x: 340, y: 405 },
  mozambique:      { name: "Mozambique",    label: "Portuguese colony until 1975. Took 500 years to notice.",  x: 408, y: 388 },
  zambia:          { name: "Zambia",        label: "Victoria Falls. National debt. Pick one to discuss.",      x: 388, y: 380 },
  papua_new_guinea:{ name: "Papua N.G.",    label: "800 languages. We know 0 of them.",                        x: 720, y: 365 },
  ecuador:         { name: "Ecuador",       label: "Gave Assange asylum. We took notes.",                      x: 153, y: 350 },
  uruguay:         { name: "Uruguay",       label: "First country to legalize weed. We're 'monitoring'.",      x: 220, y: 450 },
  nicaragua:       { name: "Nicaragua",     label: "CIA ran a secret war here. Congress said no. We did it anyway.", x: 115, y: 285 },
  costa_rica:      { name: "Costa Rica",    label: "No army since 1948. Still exists. Suspicious.",            x: 120, y: 295 },
  iceland:         { name: "Iceland",       label: "Jailed their bankers after 2008. We did not.",             x: 226, y: 95  },
  azerbaijan:      { name: "Azerbaijan",    label: "Has oil. Has a war with Armenia. We sell arms to both.",   x: 420, y: 195 },
  armenia:         { name: "Armenia",       label: "Oldest Christian nation. Keeps getting invaded anyway.",   x: 405, y: 195 },
  georgia_c:       { name: "Georgia",       label: "Russia invaded twice. We sent thoughts both times.",        x: 400, y: 185 },
  uzbekistan:      { name: "Uzbekistan",    label: "We had a base here. Then they kicked us out. Fair.",       x: 502, y: 195 },
  tajikistan:      { name: "Tajikistan",    label: "90% mountains. 100% not on our strategic map.",            x: 525, y: 205 },
  malawi:          { name: "Malawi",        label: "Landlocked. Poor. Madonna adopted a kid here. That's it.", x: 412, y: 374 },
  rwanda:          { name: "Rwanda",        label: "We watched the genocide on TV. Changed the channel.",      x: 400, y: 348 },
};
...
export const EVENTS = [
  ...
  // --- NEW: ENEMY LOSE TROOPS ---
  { text: "Rebels overthrow local government! Enemy troops desert.",                          effect: "enemy_lose_troops" },
  { text: "Insurgents ambush enemy convoy. Casualties reported.",                              effect: "enemy_lose_troops" },
  { text: "Enemy soldiers discover TikTok. Morale collapses.",                                effect: "enemy_lose_troops" },
  // --- NEW: FREE SHIELD ---
  { text: "CIA black ops succeed. Free shield deployed!",                                     effect: "shield_random" },
  { text: "Captured enemy tech reverse-engineered. Free shield!",                              effect: "shield_random" },
  // --- NEW: BUILDING DESTROYED ---
  { text: "Earthquake destroys enemy infrastructure!",                                        effect: "building_destroyed" },
  { text: "Saboteurs infiltrate enemy base. Building destroyed!",                              effect: "building_destroyed" },
  // --- NEW: ENEMY INFIGHT ---
  { text: "Enemy factions turn on each other! Infighting erupts.",                            effect: "enemy_infight" },
  { text: "Rival warlords clash over territory. Both sides weakened.",                         effect: "enemy_infight" },
  // --- NEW: BOOST ALL ---
  { text: "Patriotic surge! Volunteers everywhere. +1 troop all territories.",                effect: "boost_all" },
  { text: "Recruitment ad goes viral. +1 troop to all territories.",                           effect: "boost_all" },
  // --- NEW: ENEMY STRIKE ---
  { text: "Enemy launches surprise raid on your outpost!",                                    effect: "enemy_strike" },
  { text: "Guerrilla attack on American forward base!",                                       effect: "enemy_strike" },
  // --- NEW: HALVE COST ---
  { text: "Defense budget surplus! 50% off next purchase.",                                   effect: "halve_cost" },
  { text: "Black Friday deal at the Pentagon. 50% off next item!",                             effect: "halve_cost" },
  // --- NEW: TRIPLE INCOME ---
  { text: "Wall Street boom! Triple income this turn.",                                       effect: "extra_income" },
  { text: "Oil futures spike! Triple income this turn.",                                       effect: "extra_income" },
  // --- FLAVOR (none) — kept the best 10 ---
